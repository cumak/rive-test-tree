...
(function (module, exports) {
	...
	d)=>Fc(b,a,c,d)};(function(){function b(c){I=c=c.exports;Aa=I.R;Ha();Ia=I.X;Ka.unshift(I.S);Na--;h.monitorRunDependencies&&h.monitorRunDependencies(Na);if(0==Na&&(Pa)){var d=Pa;Pa=null;d();}return c}var a={a:Jc};Na++;h.monitorRunDependencies&&h.monitorRunDependencies(Na);if(h.instantiateWasm)try{return h.instantiateWasm(a,b)}catch(c){xa("Module.instantiateWasm callback failed with error: "+c),ca(c);}Wa(a,function(c){b(c.instance);}).catch(ca);return {}})();
...
const rainBtn = document.querySelector(".js-btn-rain");
const morningBtn = document.querySelector(".js-btn-morning");
const dayBtn = document.querySelector(".js-btn-day");
const sunsetBtn = document.querySelector(".js-btn-sunset");
const nightBtn = document.querySelector(".js-btn-night");
treeAnimation();
function treeAnimation() {
  const riveAnime = new riveExports.Rive({
